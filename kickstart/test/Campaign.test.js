...
describe("Campaign Contract", () => {
  ...
  it("creates a request", async () => {
    await campaign.methods
      .createRequest("test 1", web3.utils.toWei("1", "ether"), accounts[1])
      .send({ from: accounts[0], gas: 3000000 });
    console.log("my request 1");
    const myRequest = await campaign.methods.requestsDescription(0).call();
    console.log("my request 2", myRequest);
    assert.equal(myRequest, "test 1");
  });
});
